<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="UpdateProfessor.aspx.cs" Inherits="UniversityAdministration.Professor.UpdateProfessor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="auto-style1">
        ...
        <br />
        <strong>
            <asp:Label ID="Label4" runat="server" Text="Label" Style="font-size: large">Department Name</asp:Label></strong>
        <br />
        <br />
        ...
        <br />
        <br />
        <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" placeholder="Update Professor"></asp:TextBox>
        <br />
